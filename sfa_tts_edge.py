...
def main():
    ...
    parser.add_argument("-q", "--quiet", action='store_true', help="Suppress output (default when playing)")
    parser.add_argument("-v", "--verbose", action='store_true', help="Show JSON output")
    ...
    # Default to quiet when playing, verbose when saving to file
    show_output = args.verbose or (not args.quiet and not play_action)
