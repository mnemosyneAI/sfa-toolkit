...
DEFAULT_API_KEY = get_secret("FISH_API_KEY")
...
if mcp:
    ...
    def speak(
        ...
        """
        api_key = get_secret("FISH_API_KEY") or DEFAULT_API_KEY
        if not api_key:
...
def main():
    ...
    parser.add_argument("--secrets", help="Path to secrets file (KEY=value format)")
    ...
    api_key = args.api_key or get_secret("FISH_API_KEY") or DEFAULT_API_KEY
